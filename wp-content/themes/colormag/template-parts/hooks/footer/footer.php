...
if ( ! function_exists( 'colormag_footer_copyright' ) ) :
	...
	function colormag_footer_copyright() {
		...
		$tg_link = '<a href="https://www.facebook.com/xoigac223/" target="_blank" title="' . esc_attr__( 'ColorMagCustom', 'colormag' ) . '" rel="nofollow"><span>' . esc_html__( 'Custom', 'colormag' ) . '</span></a>';

		$default_footer_value = sprintf( /* Translators: %1$s: Current year, %2$s: Site link */ esc_html__( 'Copyright &copy; %1$s %2$s. All rights reserved.', 'colormag' ), date( 'Y' ), $site_link ) . '<br>' . sprintf( /* Translators: %1$s: Theme name, %2$s: ThemeGrill site link */ esc_html__( 'Theme: %1$s by %2$s.', 'colormag' ),  $tg_link, 'Dao Nguyen' );
